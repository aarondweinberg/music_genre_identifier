# Training our customized ResNet18 with dual features for Mel PCEN spectrograms and Chroma CQ

# Features: mel pcen spectrograms and chroma CQ graphs
# Architecture: ResNet18 (modified for our inputs)
# Inputs: Mel PCEN Spectrograms of dimension 256x128 and Chroma CQ graphs of dimension 256x12
...
train_dir1 = "./15_second_features_augmented/musicmap_processed_output_splits_train/mel_pcen_gray"
train_dir2 = "./15_second_features_augmented/musicmap_processed_output_splits_train/chroma_cq_gray"
val_dir1 = "./15_second_features_augmented/musicmap_processed_output_splits_val/mel_pcen_gray"
val_dir2 = "./15_second_features_augmented/musicmap_processed_output_splits_val/chroma_cq_gray"

output_dir = Path("trained_ResNet_outputs_pcen_chromacq")
...
train_dataloader = DataLoader(train_dataset, batch_size=64, shuffle=True, num_workers=4, prefetch_factor=2)
val_dataloader = DataLoader(val_dataset, batch_size=64, shuffle=False, num_workers=4, prefetch_factor=2)
...
with open(log_path, "w") as log_file:
	with contextlib.redirect_stdout(log_file), contextlib.redirect_stderr(log_file):
		...
		for epoch in range(num_epochs):
			...
			# --- Validation ---
			metrics = evaluate_dual(idx_to_supergenre, model_local, val_dataloader, criterion, device, shortest_graph, train_dataset)#, epoch=epoch)
