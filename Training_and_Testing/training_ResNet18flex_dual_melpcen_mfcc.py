# Training our customized ResNet18 with dual features for Mel PCEN spectrograms and MFCCs

# Features: mel pcen spectrograms and MFCC graphs
# Architecture: ResNet18 (modified for our inputs)
# Inputs: Mel PCEN Spectrograms of dimension 256x128 and MFCC graphs of dimension 256x32
...
train_dir2 = "./15_second_features_augmented/musicmap_processed_output_splits_train/mfcc_gray"
val_dir1 = "./15_second_features_augmented/musicmap_processed_output_splits_val/mel_pcen_gray"
val_dir2 = "./15_second_features_augmented/musicmap_processed_output_splits_val/mfcc_gray"

output_dir = Path("trained_ResNet_outputs_pcen_mfcc")
