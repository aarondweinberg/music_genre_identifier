# A version of ResNet18 that takes greyscale images as inputs
...
class ResNet18Gray(nn.Module):
    def __init__(self, num_classes, input_height=128):
        super(ResNet18Gray, self).__init__()
        self.in_channels = 64

        # Dynamically adjust stride and pooling based on input height
        if input_height <= 32:
            conv1_stride = 1
